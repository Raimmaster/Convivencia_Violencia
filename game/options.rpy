...
init -1 python hide:
    ...
    ##   'init'.)
python early:
    config.save_directory = "Convivencia_Violencia-1396126395"
...
init python:
    ...
    build.directory_name = "Convivencia_Violencia-1.0"

    ## The name that's uses for executables - the program that users will run
    ## to start the game. For example, if this is 'mygame', then on Windows,
    ## users can click 'mygame.exe' to start the game.
    build.executable_name = "Convivencia_Violencia"
